...
public interface TicketRepository extends JpaRepository<Ticket, Long> {
    ...
    List<Ticket> findByNameAndPriorityAndDepartmentAndStatusAndCreatedDateBetween(String name, String priority, String department, Ticket.Status status, LocalDateTime startDate, LocalDateTime endDate);
